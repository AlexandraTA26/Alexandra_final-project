...
explicit_wait()=   metoda prin care sistemul va cauta un element timp de o perioada determinata
                   ...
                   Este util in conceptul de RANDARE a paginii - uneori paginile web se pot incarca mai greu 
                            ceea ce inseamna ca unele elemente nu vor fi vizibile imediat
                    Explicit wait NU este global si va acoperi doar elementul care este scris 
...
b.2. daca avem sleep dupa elememt, atunci sistemul va returna eroare instant pentru ca nu va mai ajunge sa execute instructiunea de sleep
...
Daca avem explicit wait pe un alt element decat elementul cautat, atunci sistemul va returna eraore instant

d) Implicit wait + explicit wait
Sistemul va tine cont de timpul definit in implicit wait care are proprietate fata de explicit wait, dupa care va returna eroare
"""
chrome.get("https://the-internet.herokuapp.com/login")
username = WebDriverWait(chrome,10).until(EC.presence_of_element_located((By.ID,"username")))
